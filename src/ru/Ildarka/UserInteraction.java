...
class UserInteraction {
    /*
     *Взаимодействует с пользователем и выбирает архив с помощью JFileChooser, библиотеки swing.
     */
     static String getArchive(String name) {
    ...
    /*
     *Выводит всю информацию о сравнении на экран.
     */
     static void showResultOfComparing() {
